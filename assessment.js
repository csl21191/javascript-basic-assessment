...
var thirdHero = heroes.slice(heroes.indexOf('batman'),heroes.indexOf('batman')+1).toString();
...
var num = ['2', '3', '4'];
var reutrnedArray = addItem(num, "1");
...
/*var al = ['A', 'B', 'C', 'D'];
var reutrnedArray = removeItem(al, "D");
console.log(reutrnedArray);*/
...
function callerBack(holla, param) {
	holla(param + ' back');
}
